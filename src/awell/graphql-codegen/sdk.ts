...
export type CreatePatientMutation = { __typename?: 'Mutation', createPatient: { __typename?: 'CreatePatientPayload', patient?: { __typename?: 'User', id: string } | null } };
...
export type GetPatientQuery = { __typename?: 'Query', patient: { __typename?: 'PatientPayload', code: string, success: boolean, patient?: { __typename?: 'User', id: string, tenant_id: string, profile?: { __typename?: 'UserProfile', email?: string | null, first_name?: string | null, last_name?: string | null, name?: string | null, birth_date?: string | null, preferred_language?: string | null, sex?: Sex | null, national_registry_number?: string | null, patient_code?: string | null, phone?: string | null, mobile_phone?: string | null } | null } | null } };

export type GetPatientByIdentifierQueryVariables = Exact<{
  system: Scalars['String']['input'];
  value: Scalars['String']['input'];
}>;


export type GetPatientByIdentifierQuery = { __typename?: 'Query', patientByIdentifier: { __typename?: 'PatientPayload', patient?: { __typename?: 'User', id: string, profile?: { __typename?: 'UserProfile', email?: string | null, first_name?: string | null, last_name?: string | null, name?: string | null, sex?: Sex | null, birth_date?: string | null, phone?: string | null, mobile_phone?: string | null, preferred_language?: string | null, patient_code?: string | null, national_registry_number?: string | null, identifier?: Array<{ __typename?: 'Identifier', system: string, value: string }> | null, address?: { __typename?: 'Address', street?: string | null, city?: string | null, zip?: string | null, state?: string | null, country?: string | null } | null } | null } | null } };

export type GetPublishedPathwayDefinitionsQueryVariables = Exact<{ [key: string]: never; }>;


export type GetPublishedPathwayDefinitionsQuery = { __typename?: 'Query', publishedPathwayDefinitions: { __typename?: 'PublishedPathwayDefinitionsPayload', publishedPathwayDefinitions: Array<{ __typename?: 'PublishedPathwayDefinition', id: string, title: string, version?: number | null, release_id?: string | null, release_date?: string | null, data_point_definitions?: Array<{ __typename?: 'DataPointDefinition', id: string, key: string, title: string, category: DataPointSourceType, valueType: DataPointValueType, source_definition_id: string, unit?: string | null, optional?: boolean | null, range?: { __typename?: 'Range', min?: number | null, max?: number | null } | null, possibleValues?: Array<{ __typename?: 'DataPointPossibleValue', label?: string | null, value: string }> | null }> | null, track_definitions?: Array<{ __typename?: 'Track', id: string, title: string, can_trigger_manually?: boolean | null }> | null }> } };
...
export type StartPathwayWithPatientIdentifierMutationVariables = Exact<{
  input: StartPathwayWithPatientIdentifierInput;
}>;


export type StartPathwayWithPatientIdentifierMutation = { __typename?: 'Mutation', startPathwayWithPatientIdentifier: { __typename?: 'StartPathwayWithPatientIdentifierPayload', pathway_id: string, patient_id: string } };
...
export type UpdatePatientMutation = { __typename?: 'Mutation', updatePatient: { __typename?: 'UpdatePatientPayload', patient?: { __typename?: 'User', id: string } | null } };
...
export const GetPatientDocument = gql`
  ...
  patient(id: $patientId) {
    ...
    `;
export const GetPatientByIdentifierDocument = gql`
...
export const StartPathwayDocument = gql`
  ...
  startPathway(input: $input) {
    ...
    `;
export const StartPathwayWithPatientIdentifierDocument = gql`
...
const GetPatientDocumentString = print(GetPatientDocument);
const GetPatientByIdentifierDocumentString = print(GetPatientByIdentifierDocument);
const GetPublishedPathwayDefinitionsDocumentString = print(GetPublishedPathwayDefinitionsDocument);
const StartPathwayDocumentString = print(StartPathwayDocument);
const StartPathwayWithPatientIdentifierDocumentString = print(StartPathwayWithPatientIdentifierDocument);
const UpdatePatientDocumentString = print(UpdatePatientDocument);
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    CreatePatient(variables: CreatePatientMutationVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<{ data: CreatePatientMutation; errors?: GraphQLError[]; extensions?: any; headers: Headers; status: number; }> {
        return withWrapper((wrappedRequestHeaders) => client.rawRequest<CreatePatientMutation>(CreatePatientDocumentString, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'CreatePatient', 'mutation', variables);
    },
    getPatient(variables: GetPatientQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<{ data: GetPatientQuery; errors?: GraphQLError[]; extensions?: any; headers: Headers; status: number; }> {
        return withWrapper((wrappedRequestHeaders) => client.rawRequest<GetPatientQuery>(GetPatientDocumentString, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'getPatient', 'query', variables);
    },
    GetPatientByIdentifier(variables: GetPatientByIdentifierQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<{ data: GetPatientByIdentifierQuery; errors?: GraphQLError[]; extensions?: any; headers: Headers; status: number; }> {
        return withWrapper((wrappedRequestHeaders) => client.rawRequest<GetPatientByIdentifierQuery>(GetPatientByIdentifierDocumentString, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'GetPatientByIdentifier', 'query', variables);
    },
    GetPublishedPathwayDefinitions(variables?: GetPublishedPathwayDefinitionsQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<{ data: GetPublishedPathwayDefinitionsQuery; errors?: GraphQLError[]; extensions?: any; headers: Headers; status: number; }> {
        return withWrapper((wrappedRequestHeaders) => client.rawRequest<GetPublishedPathwayDefinitionsQuery>(GetPublishedPathwayDefinitionsDocumentString, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'GetPublishedPathwayDefinitions', 'query', variables);
    },
    StartPathway(variables: StartPathwayMutationVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<{ data: StartPathwayMutation; errors?: GraphQLError[]; extensions?: any; headers: Headers; status: number; }> {
        return withWrapper((wrappedRequestHeaders) => client.rawRequest<StartPathwayMutation>(StartPathwayDocumentString, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'StartPathway', 'mutation', variables);
    },
    StartPathwayWithPatientIdentifier(variables: StartPathwayWithPatientIdentifierMutationVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<{ data: StartPathwayWithPatientIdentifierMutation; errors?: GraphQLError[]; extensions?: any; headers: Headers; status: number; }> {
        return withWrapper((wrappedRequestHeaders) => client.rawRequest<StartPathwayWithPatientIdentifierMutation>(StartPathwayWithPatientIdentifierDocumentString, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'StartPathwayWithPatientIdentifier', 'mutation', variables);
    },
    UpdatePatient(variables: UpdatePatientMutationVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<{ data: UpdatePatientMutation; errors?: GraphQLError[]; extensions?: any; headers: Headers; status: number; }> {
        return withWrapper((wrappedRequestHeaders) => client.rawRequest<UpdatePatientMutation>(UpdatePatientDocumentString, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'UpdatePatient', 'mutation', variables);
    }
  };
}
